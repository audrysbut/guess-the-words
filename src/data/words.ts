import type { WordEntry, Theme, Language } from '@/types/game'
import { getRandomWordLt } from './words.lt'

const rawWordBank: Record<Theme, Array<{ answer: string; tokens: string[] }>> = {
  movies: [
